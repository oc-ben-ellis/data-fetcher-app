...
class RunConfig:
    ...
    stage: str | None = environ.var(
        default=None,
        help="Pipeline stage (e.g., fetcher). Required if --data-registry-id is specified.",
    )
    step: str | None = environ.var(
        default=None,
        help="Pipeline step used for config selection (e.g., fetcher). "
...
create_app_config = create_fetcher_app_config
