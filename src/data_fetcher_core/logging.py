...
def parse_logging_config() -> Mapping[str, Any]:
    ...
    _default_package_log_level(package_log_levels, "asyncssh", LoggingLevel.WARNING)
    _default_package_log_level(package_log_levels, "paramiko", LoggingLevel.WARNING)
    _default_package_log_level(package_log_levels, "pysftp", LoggingLevel.WARNING)
