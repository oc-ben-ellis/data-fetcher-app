...
from data_fetcher.bundle_locators.api_pagination_bundle_locators import (
...
from data_fetcher.global_credential_provider import get_default_credential_provider
from data_fetcher.protocols.authentication import OAuthAuthenticationMechanism
...
def _setup_fr_api_fetcher(
    ...
    if end_date is None:
        end_date = (
            datetime.datetime.now(tz=datetime.timezone.utc).date().strftime("%Y-%m-%d")
        )
