"""Health check and status endpoints for the data fetcher application.
...
class HealthCheck:
    ...
    def __init__(self, app_name: str = "data-fetcher-app") -> None:
...
def create_health_app(app_name: str = "data-fetcher-app") -> SimpleWSGIRouter:
