...
from oc_pipeline_bus.config import RelativeConfig
...
class SftpLoaderConfig:
    ...
    sftp_config: Annotated[SftpProtocolConfig, "path:protocols.sftp.{value}", "relative_config"]
...
class SftpDirectoryLocatorConfig:
    ...
    file_filter: Annotated[FileFilter, "strategy"] | None = None
...
class DirectorySftpBundleLocatorFactory(StrategyFactory):
    ...
    def create(self, params: Any) -> DirectorySftpBundleLocator:
        ...
        if is_dataclass(params):
            ...
            sort_key = getattr(params, "sort_key", None)
            sort_reverse = getattr(params, "sort_reverse", True)
            ...
            sort_reverse = params.get("sort_reverse", True)
...
def register_sftp_strategies(registry, sftp_manager: SftpManager) -> None:
    ...
    registry.register(LoaderStrategy, "sftp_loader", SftpBundleLoaderFactory(sftp_manager))
    ...
    registry.register(LocatorStrategy, "sftp_file", FileSftpBundleLocatorFactory(sftp_manager))
